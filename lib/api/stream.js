...
/**
 * This should be called for every new peer connected
 * @param {Peer} peer
 */
...
/**
 * This should be called for every new log
 * @param {Object} log
 * @param {string} log.origin
 * @param {Date} log.date
 * @param {string} log.name
 * @param {number} log.level
 * @param {number} log.relevance
 * @param {?number} log.time
 * @param {?string} log.message
 * @param {?Buffer} log.commit
 * @param {?*} log.extra
 */
module.exports.onlog = function (log) {
